...
Constructors use a class-derived name without a return annotation. Their bodies
follow void return rules, while a type-name constructor call produces the new
file-class object.
