...
| `artifact_schema_v6.md`, `data_layout_and_abi.md`, `llvm_backend.md` | Tooling compatibility and target limits |
...
- Artifact compatibility follows v6 / compiler ABI 5 / runtime ABI 7; process
