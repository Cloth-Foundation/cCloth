...
and source-free dependencies are supported by artifact format 4. Compiler ABI 4
and runtime ABI 2 are compiler-owned; Shuttle requires format 4 in capabilities
