...
namespace cloth {
	namespace error {
		...
		static std::string toString(ErrorType error) {
			switch (error) {
				case ErrorType::SYNTAX_ERROR: return std::string("Syntax Error"); break;
				case ErrorType::COMPILER_ERROR: return std::string("Compiler Error"); break;
				case ErrorType::PARSING_ERROR: return std::string("Parsing Error"); break;
