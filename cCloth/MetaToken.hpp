...
namespace cloth {
	namespace meta_token {
		...
		public:
			cloth::token::TokenKind kind = cloth::token::TokenKind::Error;
			...
			constexpr MetaToken(cloth::token::TokenKind kind, cloth::token::SourceSpan span, std::string_view lexeme, MetaKeyword keyword = MetaKeyword::None) noexcept
				: kind(kind), keyword(keyword), span(span), lexeme(lexeme) {
			}

			[[nodiscard]] constexpr bool is(cloth::token::TokenKind kind) const noexcept {
